...
public class HeartsModel {
	...
	public int evaluateTrickCards() {
        ...
        public int getWhoStartedTrick(){return this.whoStartedTrick;
}
        ...
        public String getWinnerName(){
        	int lowestScore = players[0].getOverallPoints();
        	String lowestScoreName = players[0].getName();
        	for(int i =0;i<NUM_PLAYERS;i++){
        		if(players[i].getOverallPoints()<lowestScore){
        			lowestScore = players[i].getOverallPoints();
        			lowestScoreName = players[i].getName();
				}
			}
			return lowestScoreName;
		}
        public String getOverallPoints(){
        	String points = "";
        	for(int i=0;i<NUM_PLAYERS;i++){
        		points += players[i].getName()+": "+players[i].getOverallPoints()+"\n";
			}
			return points;
        }
	/**
